...
# customer data
customer_data = pd.read_csv("MachineLearning1//Book_Recommendation_System//data//comments.csv", sep=",").iloc[:, :-1]
...
# book data
book_data = pd.read_csv("MachineLearning1//Book_Recommendation_System//data//book_data.csv", sep=",")
